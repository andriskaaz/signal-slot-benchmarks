...
#include "../lib/TheWisp/signals/signals.hpp"

#include "../../benchmark.hpp"

class Fts
{
    fteng::connection reg;
    ...
    {
        foo.reg = subject.template connect<&Foo::handler>(&foo);
    }
    ...
    static constexpr const char* C_LIB_NAME = "TheWisp Signals";
